  ...
  <form method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td><input type="text" name="total_items_display" value="<?php echo get_option( 'total_items_display' ); ?>"/></td>
        </tr> 
        <tr valign="top">
            ...
            <td>
                ...
                &nbsp;&nbsp;&nbsp;NOTE: This will be applicable on single product page
            </td>
        </tr> 
        <tr valign="top">
    ...
    <?php submit_button(); ?>
        <br>
        <h2>WooCommerce - Customer Who Viewed This Item Also Viewed Shortcode</h2>
        <hr>
        <div> 1) To use shortcode in a PHP file (outside the post editor). <br>
<pre> echo do_shortcode('[customer_also_viewed]'); </pre> <br>
    2) To use shortcode inside the post editor.
<pre> [customer_also_viewed] </pre> <br>
        </div>
  </form>
...
function zwt_woocommerce_customer_also_viewed( $atts, $content = null ) {
        ...
        $customer_also_viewed = array_reverse(array_filter( array_map( 'absint', $customer_also_viewed )));
    ...
    <?php } 
         ...
         // If no data, quit
            return __( 'You have not viewed any product yet!', 'woocommerce' );
        }
        wp_reset_postdata();
}

// Register the shortcode
add_shortcode("customer_also_viewed", "zwt_woocommerce_customer_also_viewed");
